...
class Dataset(object):
    ...
    def __init__(self, batch_size, shuffle=True, train_bins=[], validation_bins=[], data_path='data/', seed=None):
        """
	...
	#read data from file
        ...
        self.X_tr, self.y_tr, self.X_val, self.y_val = self._load_training_data()
